 ...
 */
public class DoEventOnTrackballDown implements TrackballListener ,IRemovable {


	private IEvent mEvent;
	private boolean mSync;

	private DoEventOnTrackballDown(IEvent event, boolean sync)
	{
		mEvent = event;
		mSync = sync;
	...
	public static DoEventOnTrackballDown add(GameNode addtogamenode,IEvent event, boolean sync)
	{
		DoEventOnTrackballDown de = new DoEventOnTrackballDown(event, sync);
		addtogamenode.addRemovable(de);
		return de;
	}

	public static DoEventOnTrackballDown add(GameNode addtogamenode, IEvent event)
	{
